...
// ─── Client-side cache for instant revisits ──────────────────────────────────
...
export default function Feature1Route() {
  ...
  return (
    <div style={S.page}>
      <h1 style={{ fontSize: 22, fontWeight: 700, color: "#111827", marginBottom: 8 }}>Trust Badges</h1>
      <p style={{ fontSize: 14, color: "#6B7280", margin: "0 0 20px" }}>Configure product badges, countdown timers, and scheduling for your storefront.</p>
